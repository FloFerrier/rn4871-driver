...
void receiveData_ModuleOnCmdMode(void **state)
{
    ...
    assert_int_equal(rn4871WaitReceivedData(module, receivedData, &receivedDataLen), CODE_RETURN_NO_DATA_MODE);
}
...
{
    RN4871_MODULE *module = *state;
    assert_int_equal(rn4871SetServices(module, UART_TRANSPARENT | DEVICE_INFORMATION), CODE_RETURN_NO_COMMAND_MODE);
}
...
void trySetServices_UartTransparentSuccess(void **state)
{
    ...
    mock_rn4871UartRxCb("AOK\r\nCMD>", CODE_RETURN_SUCCESS);
    assert_int_equal(rn4871SetServices(module, UART_TRANSPARENT | DEVICE_INFORMATION), CODE_RETURN_SUCCESS);
}
...
void trySetDeviceName_ModuleNotOnCmdMode(void **state)
{
    ...
    assert_int_equal(rn4871SetDeviceName(module, deviceName), CODE_RETURN_NO_COMMAND_MODE);
}
...
void trySetDeviceName_Success(void **state)
{
    ...
    mock_rn4871UartRxCb("AOK\r\nCMD>", CODE_RETURN_SUCCESS);
    assert_int_equal(rn4871SetDeviceName(module, deviceName), CODE_RETURN_SUCCESS);
}
...
void tryGetFirmwareVersion_ModuleNotOnCmdMode(void **state)
{
    ...
    assert_int_equal(rn4871GetFirmwareVersion(module, firmwareVersion, BUFFER_SIZE_MAX-1), CODE_RETURN_NO_COMMAND_MODE);
}
...
void tryGetFirmwareVersion_Success(void **state)
{
    ...
    assert_int_equal(rn4871GetFirmwareVersion(module, firmwareVersion, BUFFER_SIZE_MAX-1), CODE_RETURN_SUCCESS);
...
void tryGetServices_ModuleNotOnCmdMode(void **state)
{
    ...
    assert_int_equal(rn4871GetServices(module, &services), CODE_RETURN_NO_COMMAND_MODE);
}
...
void tryGetDeviceName_ModuleNotOnCmdMode(void **state)
{
    ...
    assert_int_equal(rn4871GetDeviceName(module, deviceName, BUFFER_SIZE_MAX-1), CODE_RETURN_NO_COMMAND_MODE);
}
...
void tryGetDeviceName_Success(void **state)
{
    ...
    mock_rn4871UartTxCb("D\r\n", CODE_RETURN_SUCCESS);
    mock_rn4871UartRxCb("BTA=none\r\nName=test_rn4871\r\nConnected=no\r\nAuthen=0\r\nFeatures=0000\r\nServices=00\r\nCMD>", CODE_RETURN_SUCCESS);
    assert_int_equal(rn4871GetDeviceName(module, deviceName, BUFFER_SIZE_MAX-1), CODE_RETURN_SUCCESS);
...
void tryGetMacAddress_ModuleNotOnCmdMode(void **state)
{
    ...
    assert_int_equal(rn4871GetMacAddress(module, macAddress, BUFFER_SIZE_MAX-1), CODE_RETURN_NO_COMMAND_MODE);
}
...
void tryGetMacAddress_Success(void **state)
{
    ...
    assert_int_equal(rn4871GetMacAddress(module, macAddress, BUFFER_SIZE_MAX-1), CODE_RETURN_SUCCESS);
...
void checkTransparentUartMode_isTrue(void **state)
{
    ...
    mock_rn4871UartTxCb("D\r\n", CODE_RETURN_SUCCESS);
    mock_rn4871UartRxCb("BTA=001122334455\r\nName=test_rn4871\r\nConnected=no\r\nAuthen=0\r\nFeatures=0000\r\nServices=C0\r\nCMD>", CODE_RETURN_SUCCESS);
    assert_int_equal(rn4871IsOnTransparentUart(module, &result), CODE_RETURN_SUCCESS);
    assert_true(result);
}
...
void trySendDataOnTransparentUart_ModuleNotOnDataMode(void **state)
{
    ...
    mock_rn4871EnterCommandMode(module);
    assert_int_equal(rn4871TransparentUartSendData(module, dataToSend, dataToSendLen), CODE_RETURN_NO_DATA_MODE);
}
...
void trySendDataOnTransparentUart_NoStreaming(void **state)
{
    ...
    char dataToSend[] = "Test data send by transparent UART";
    uint16_t dataToSendLen = (uint16_t) strlen(dataToSend);
    assert_int_equal(rn4871TransparentUartSendData(module, dataToSend, dataToSendLen), CODE_RETURN_NO_STREAMING);
}
...
void getErrorCodeStr_CorrectCode(void **state)
{
    ...
    {
        assert_string_equal(rn4871GetErrorCodeStr((RN4871_CODE_RETURN) i), errorCodeStr[i]);
    }
}