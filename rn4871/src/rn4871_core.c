...
#ifndef RN4871_UTEST
static RN4871_CODE_RETURN rn4871SendCmd(RN4871_MODULE *dev, RN4871_CMD cmd,
                                        const char *format, ...);
static RN4871_CODE_RETURN rn4871ResponseProcess(RN4871_MODULE *dev,
                                                const char *response);
static RN4871_CODE_RETURN rn4871ParseDumpInfos(const char *infos,
                                               RN4871_DUMP_INFOS_FIELD field,
                                               char *result,
                                               uint16_t resultMaxLen);
static RN4871_CODE_RETURN rn4871ParseFirmwareVersion(
...
RN4871_CODE_RETURN rn4871WaitReceivedData(RN4871_MODULE *dev,
                                          char *receivedData,
...
RN4871_CODE_RETURN rn4871SetDeviceName(RN4871_MODULE *dev,
...
RN4871_CODE_RETURN rn4871GetFirmwareVersion(RN4871_MODULE *dev,
...
RN4871_CODE_RETURN rn4871TransparentUartSendData(RN4871_MODULE *dev,
